...
#grid(
  ...
  [#image("assets/arda.jpg", width: 4cm)], [
    *Arda Baysal*\
    ...
    Interests: Point clouds, geospatial data visualisation, digital terrain modelling
  ],
